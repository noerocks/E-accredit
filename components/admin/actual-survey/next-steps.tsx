...
import LevelThreeAdditional from "./level-three-additional";
import LevelFourAdditional from "./level-four-additional";
    ...
    <div className="flex flex-col gap-2">
      <Card className="bg-background">
        ...
        <CardContent className="flex flex-col gap-2">
          ...
          {level?.rank === 2 && <LevelFourAdditional />}
          {level?.rank === 4 && <LevelThreeAdditional />}
        </CardContent>
      </Card>
