        ...
        return (
          ...
          >
            ...
            <CardContent className="flex flex-col gap-2">
              <Tabs
                defaultValue={
                  visit.surveyResultStatus === "PENDING" ? "self" : "actual"
                }
              >
                <TabsList className="border">
                  <TabsTrigger value="self">Self Survey</TabsTrigger>
                  <TabsTrigger value="actual">Actual Survey</TabsTrigger>
                </TabsList>
                <TabsContent value="self" className="p-1">
                ...
                <TabsContent value="actual" className="p-1">
                  <div className="flex flex-col gap-1">
                    <div className="flex justify-between items-center">
                      <p className="text-sm text-muted-foreground flex items-center gap-1">
                        <CircleDot size={15} />
